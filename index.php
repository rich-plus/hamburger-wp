...
<main class="l-main">
	...
	<picture>
		<source srcset="./images/top/mv--pc.jpg" media="( min-width: 1024px )">
		<source srcset="./images/top/mv--tb.jpg" media="( min-width: 768px )">
		<img class="c-visual__img p-mv__img" src="./images/top/mv--sp.jpg" alt="ハンバーガーショップのメインビジュアル画像">
	</picture>
	<h1 class="c-visual__title p-mv__title c-color--text-inverse">ダミーサイト</h1>
	</section>

	<div class="c-layout__container">
	<a href="/archive.html" class="p-menu-card p-menu-card--takeout js-fade-link">
	...
	<a href="/archive.html" class="p-menu-card p-menu-card--eatin js-fade-link">
	...
	<picture class="p-access__bg">
		<source srcset="./images/top/access--pc.jpg" media="(min-width: 1024px)">
		<source srcset="./images/top/access--tb.jpg" media="(min-width: 768px)">
		<img src="./images/top/access--sp.jpg" alt="店舗周辺の地図">
	</picture>
