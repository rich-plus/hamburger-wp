    ...
    <div class="c-layout__wrapper-inner">
      ...
      <main class="l-main p-single">
        <section class="c-visual c-visual--center-y p-single__mv">
          <picture>
            <source srcset="./images/shop/shop--pc.jpg" media="( min-width: 1024px )">
            <source srcset="./images/shop/shop--tb.jpg" media="( min-width: 768px )">
            <img class="c-visual__img p-single__mv-img" src="./images/shop/shop--sp.jpg" alt="ハンバーガーショップの外観">
          </picture>
